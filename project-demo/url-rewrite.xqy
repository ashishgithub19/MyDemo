...
let $request-url :=
	...
	else if (fn:contains($request-url, "studentResult")) then
        concat("/demo/student_result.xqy?", substring-after(xdmp:get-request-url(), "?")) 
	else if (fn:contains($request-url, "studentDes")) then
        concat("/demo/student_description.xqy?", substring-after(xdmp:get-request-url(), "?"))
	else if (fn:contains($request-url, "Search")) then
        concat("/demo/search_student.xqy?", substring-after(xdmp:get-request-url(), "?"))
